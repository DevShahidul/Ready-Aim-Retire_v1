import { C as decryptString, G as createSlotValueFromString, H as isAstroComponentFactory, r as renderComponent, a as renderTemplate, J as ROUTE_TYPE_HEADER, K as REROUTE_DIRECTIVE_HEADER, A as AstroError, O as i18nNoLocaleFoundInPath, P as ResponseSentError, Q as ActionNotFoundError, S as MiddlewareNoDataOrNextCalled, T as MiddlewareNotAResponse, V as originPathnameSymbol, W as RewriteWithBodyUsed, X as GetStaticPathsRequired, Y as InvalidGetStaticPathsReturn, Z as InvalidGetStaticPathsEntry, _ as GetStaticPathsExpectedParams, $ as GetStaticPathsInvalidRouteParam, a0 as PageNumberParamNotFound, D as DEFAULT_404_COMPONENT, a1 as NoMatchingStaticPathFound, a2 as PrerenderDynamicEndpointPathCollide, a3 as ReservedSlotName, a4 as renderSlotToString, a5 as renderJSX, a6 as chunkToString, a7 as isRenderInstruction, a8 as ForbiddenRewrite, a9 as SessionStorageInitError, aa as SessionStorageSaveError, ab as ASTRO_VERSION, ac as CspNotEnabled, ad as LocalsReassigned, ae as generateCspDigest, af as PrerenderClientAddressNotAvailable, ag as clientAddressSymbol, ah as ClientAddressNotAvailable, ai as StaticClientAddressNotAvailable, aj as AstroResponseHeadersReassigned, ak as responseSentSymbol$1, al as renderPage, am as REWRITE_DIRECTIVE_HEADER_KEY, an as REWRITE_DIRECTIVE_HEADER_VALUE, ao as renderEndpoint, ap as LocalsNotAnObject, aq as REROUTABLE_STATUS_CODES, ar as nodeRequestAbortControllerCleanupSymbol } from './astro/server_DZIuF2pX.mjs';
import colors from 'piccolore';
import 'clsx';
import { A as ActionError, d as deserializeActionResult, s as serializeActionResult, a as ACTION_RPC_ROUTE_PATTERN, b as ACTION_QUERY_PARAMS, g as getActionQueryString, D as DEFAULT_404_ROUTE, c as default404Instance, N as NOOP_MIDDLEWARE_FN, e as ensure404Route } from './astro-designed-error-pages_L5RKzQvY.mjs';
...
function createStaticHandler(app, options) {
  ...
  return (req, res, ssr) => {
    if (req.url) {
      ...
      try {
        isDirectory = fs__default.lstatSync(filePath).isDirectory();
      } catch {
      }
