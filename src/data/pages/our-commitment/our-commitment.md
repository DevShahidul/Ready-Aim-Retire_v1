...
commitmentCards: 
  - id: 1
    title: "Supporting Operation HOPE"
    subtitle: "Partnering with organizations making a real difference."
    description: "We are proud to support Operation HOPE, a nonprofit organization dedicated to advancing financial dignity and economic opportunity through education, coaching, and empowerment."
    shortDescription: ""
    list: 
      title: "Operation HOPE works to:"
      listItems: 
        - "Promote financial literacy and credit education"
        - "Support underserved communities"
        - "Help individuals build long-term financial confidence"
  ...
  - id: 2
    ...
    list: 
      ...
      listItems: 
        - "Email us from your <strong>.edu email address</strong>"
        - "We’ll set up a <strong>free Pro account</strong> for you"
        - "No credit card required"
    firstBottomText: "This gives students full access to advanced planning tools- including scenario modeling, stress testing, budgeting, and long-term projections - so they can start building confidence early."
    secondBottomText: ""
    emailInfo:
        title: "Email us at:"
  ...
  - id: 3
    ...
    list: 
      ...
      listItems: 
        ...
        - "We don’t push financial products"
...
ctaInfo: 
  ...
  description: "If you believe in clarity, education, and empowerment, you’re already aligned with our mission."
