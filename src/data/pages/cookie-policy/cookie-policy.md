...
---
  ...
  <section>
    ...
    <p>
      ...
      They help websites remember your preferences, recognize your device, and
  ...
  <ul>
    ...
    <li><strong>Third-party cookies</strong> (set by service providers we use)</li>
  </ul>
  <section>
    ...
    <h3>d. Marketing Cookies (Limited Use)</h3>
    <p>
    ...
    <p>
      We do <strong>not</strong> use cookies to profile users based on financial
      data or sell personal information.
    </p>
  </section>
  <section>
    ...
    <p>
      These providers are contractually obligated to use information only for
  ...
  <section>
    ...
    <p>
      Please note that disabling certain cookies may impact the functionality of
      the Services.
    </p>
  </section>
  <section>
    <h2>5. GDPR Cookie Rights (EEA &amp; UK)</h2>
    <p>
  ...
  <section>
    <h2>6. CCPA / CPRA Cookie Rights (California Residents)</h2>
    <p>
    ...
    <p>
      Ready Aim Retire does <strong>not</strong> sell or share personal information
  ...
  <p>
      Email:
      <a href="mailto:privacy@readyaimretire.co">
        privacy@readyaimretire.co
      </a>
  </p>
